enum AgeGroup {
  ...
  const AgeGroup({required this.age, required this.assetPath, required this.description});
  static AgeGroup fromAge(int age) {
  return AgeGroup.values.firstWhere((group) => group.age == age, orElse: () => AgeGroup.young);}
}