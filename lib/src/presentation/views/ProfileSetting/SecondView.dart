...
class SecondView extends StatelessWidget {
                ...
                children: [
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          _buildTitleRow(
                            context, 
                            "ID ", 
                            "상대방이 내 쿠키를 뽑았을때 보여집니다."
                          ),
                          _buildTextField(
                            'Enter your phone number or instaID',
                          ...
                          _buildTextField(
                            'ex) 수누리',
                            viewModel.restaurantController
                          ),
                        ],
                      ),
                    ),
                  ...
                  SizedBox(
                    ...
                    child: CupertinoButton(
                     onPressed: !viewModel.isButtonDisabled ? () async {
  ...
  Widget _buildTitleRow(BuildContext context, String title, String description) {
    return Row(
